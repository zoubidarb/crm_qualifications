odoo.define('mail.systray.LeadsMenu', function (require) {
    "use strict";
    ...
    var LeadsMenu = Widget.extend({
        name: 'leads_menu',
        template: 'mail.systray.LeadsMenu',
        events: {
        ...
        */
        _updateActivityPreview: function () {
            ...
            self._getActivityData().then(function () {
                self._$activitiesPreview.html(QWeb.render('mail.systray.LeadsMenu.Previews', {
    ...
    SystrayMenu.Items.push(LeadsMenu);
    return LeadsMenu;
